    ...
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-black/40 z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col items-center">
        ...
        <div className="flex justify-between w-[80%]">
          <button
            onClick={onContinue}
            className="mt-[1vh] px-4 py-1 text-white bg-red-500 rounded hover:bg-red-600 transition-colors"
          >
            Yes
          </button>
          <button
            onClick={onClose}
            className="mt-[1vh] px-4 py-1 text-gray-700 bg-gray-200 rounded hover:bg-gray-300 transition-colors"
          >
            Cancel
          </button>
        </div>
